...
4. Install Paramiko, python-dotenv, python-nmap, pyinstaller, numpy, pandas, matplotlib, and scp with pip. This will be corrected to a requirements.txt file in a later version
5. Clone the repo
